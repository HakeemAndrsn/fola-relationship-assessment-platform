...
(async () => {
  console.log("🚀 Initializing FOLA Inner Child Somatic Workbook PDF Generation with base64 cover...");
...
<head>
  <meta charset="UTF-8">
  <title>The Inner Child Somatic Workbook — FOLA</title>
  <style>
...
<body>
  ...
  <div class="page">
    <div class="header">
      <span class="header-logo">FOLA Practice</span>
      <span>Day 3: Audio Preparation</span>
    </div>
    
    <div class="title-area" style="margin-top: 10mm;">
      <div class="page-number-large">03</div>
      <h1>Quietening the Nervous System</h1>
      <div class="subtitle">Nervous System Check-In before the Audio</div>
    </div>
    
    <p class="instruction-text">
      Complete this page right before you listen to the Step 1 Regression Audio. Are you walking around in high alert (shoulders tight, jaw clenched, heart racing) or flatly shut down (feeling numb, exhausted, hiding behind your screen)?
    </p>
    ...
    <div class="journal-box" style="margin-top: 15px;">
      <span class="journal-box-label">Set your intention: What is your adult self promising to protect during this session?</span>
      <div class="journal-line"></div>
      <div class="journal-line"></div>
      <div class="journal-line"></div>
      <div class="journal-line"></div>
  ...
  <div class="page">
    ...
    <div class="title-area" style="margin-top: 10mm;">
      ...
      <div class="subtitle">Transcribing what arose during the Audio</div>
    </div>
    
    <p class="instruction-text">
      Open your eyes from the regression. Immediately, while your thinking mind is quiet, write down what your younger self spoke. What did they ask for? What did they need you to hear?
    </p>
  ...
  try {
    ...
    const pdfPath = "/Users/fola/.gemini/antigravity-cli/brain/91893e3d-83bb-4259-a3fd-eb5a4f255470/FOLA_Inner_Child_Somatic_Workbook.pdf";
    ...
    const webPath = "/Users/fola/fola-website-design/public/downloads/FOLA_Inner_Child_Somatic_Workbook.pdf";
