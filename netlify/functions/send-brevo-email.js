    ...
    const htmlContent = `
      ...
      <body>
        <div class="container">
          ...
          <p>Thank you for purchasing <strong>${escapeHtml(product.name)}</strong> from LOVEBETTER by FOLA. Your payment was confirmed.</p>
          ...
          <p>This download link will remain active. If you need any support, please contact us at admin@fola.co.za.</p>
